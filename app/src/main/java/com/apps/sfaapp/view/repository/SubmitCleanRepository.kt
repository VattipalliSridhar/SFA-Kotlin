...
class SubmitCleanRepository {
    suspend fun saveCleanData(
      ...
      return withContext(Dispatchers.IO){
            RetrofitClient.apiInterface.saveCleanData(accessKey,loginStatus,jawanId,toiletId,ulbId,latt,lanng,scannedCode,dateTime,cleanStatus,zonId,selectedIdsArray)
        }
    }
