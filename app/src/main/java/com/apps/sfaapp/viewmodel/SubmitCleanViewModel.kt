...
class SubmitCleanViewModel : ViewModel() {
    ...
    fun saveDataClean(
        ...
        viewModelScope.launch {
            response =  submitCleanRepository.saveCleanData(accessKey,loginStatus,jawanId,toiletId,ulbId,latt,lanng,scannedCode,dateTime,cleanStatus,zonId,selectedIdsArray)
